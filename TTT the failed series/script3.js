//Copy of script1. Intent is to move the bits into better defined modules.
//Functions and Modules: eventListeners, playerFactory, gameLogic, displayController
...
const gameLogic = (() => {
  ...
  // return { tileClickHandler, tileID };
})();
...
const displayController = (() => {
  ...
  playAgain.addEventListener("click", () => {
    ...
    clearSelectedTiles();
    playedTiles = [];
    playerFactory.eventListeners.addButtonEventListeners();
    console.log(
      "playAgain",
  ...
  function removeTileListeners() {
    ...
    tiles.forEach((tile) => {
      tile.removeEventListener("click", eventListener.tileClickHandler);
  ...
  function markTile(tileID) {
    ...
    if (!playedTiles.includes(tileID)) {
      ...
      console.log(
        "markTile return:",
        currentPlayer.marker, 'player Selected Tile:',
        playerSelectedTile,
        "tileID:",
        tileID,
        "global tileID:",
      ...
      //return button, tileID; //10/2 redundant
    }
  }
  ...
  const eventListeners = (() => {
    ...
    function addButtonEventListeners() {
      ...
      buttons.forEach((button) => {
        button.addEventListener("click", gameLogic.tileClickHandler);
